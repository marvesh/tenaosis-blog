...
//     sub_content: "Technology isn't the 'villain'—it's a lack of boundaries. When we prioritize the digital over the biological, we stop living and start becoming mechanical. Natural living is messy, slow, and tactile; tech is clean, fast, and sterile. In the balance between the two, you find healthy living.",
